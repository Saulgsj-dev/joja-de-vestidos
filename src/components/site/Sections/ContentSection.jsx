    ...
    <section className="py-8 sm:py-12 px-4" style={backgroundStyle}>
      <div className="max-w-4xl mx-auto">
        {content.image && styles?.imagePosition !== 'below' && (
          <img src={content.image} alt={content.title} className={`w-full ${getImageSizeClasses()} object-cover rounded-lg mb-4 shadow-md`} />
        )}
        ...
        {content.image && styles?.imagePosition === 'below' && (
          <img src={content.image} alt={content.title} className={`w-full ${getImageSizeClasses()} object-cover rounded-lg mt-4 shadow-md`} />
        )}
